    ...
    const deleteInformation = async (row, column) => {
        const result = await Swal.fire({
          ...
          if (result.isConfirmed) {
            const url = baseURL + '/Inmates/DeleteInamte/'+row.id ;
            const response = await fetch(url, {
                method:'DELETE',
                headers:{
                    'Authorization' : 'Bearer '+ token
                                    ...
                                    if(column.id == "inmateName"){
                                        return (
                                            <TableCell
                                                key={column.id}
                                                align={column.align}
                                                onClick={() => handleInmateClick(row)} // Pass the entire row to the function
                                                >
